     ...
     <div className='flex  justify-center gap-28 mb-10  flex-grow'>
      ...
      <input
        ...
        <div className='mt-8 flex flex-col gap-y-4'>
          <button className='active:scale-[.98] active:duration-75 hover-[1.01] ease-in-out transition-all py-3 rounded-xl bg-orange-400 text-white text-lg font-bold'>Send OTP</button>
          <button 
